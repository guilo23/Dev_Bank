...
public class AccountServiceTest {
  ...
  void shouldThrowExceptionWhenAccountNotFoundForDeposit() {
    ...
    assertThrows(
        EntityNotFoundException.class, () -> accountService.accountDeposit(update, accountNumber));
  }
  ...
  void shouldThrowExceptionWhenAccountNotFoundForWithdraw() {
    ...
    assertThrows(
        EntityNotFoundException.class, () -> accountService.accountCashOut(update, accountNumber));
  }
