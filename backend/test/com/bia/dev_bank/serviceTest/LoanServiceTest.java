...
class LoanServiceTest {
  ...
  void shouldCreateLoanSuccessfully() {
    ...
    Long customerId = 1L;
    LoanRequest request =
        new LoanRequest(new BigDecimal("10000"), new BigDecimal("0.1"), 12, LoanType.PERSONAL);
  ...
  void shouldThrowExceptionWhenCustomerNotFound() {
    ...
    Long customerId = 99L;
    LoanRequest request =
        new LoanRequest(new BigDecimal("5000"), new BigDecimal("0.15"), 10, LoanType.PERSONAL);
