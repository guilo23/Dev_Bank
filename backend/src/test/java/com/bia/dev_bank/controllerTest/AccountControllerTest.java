...
public class AccountControllerTest {
    ...
    void shouldCreateAccountSuccessfully() throws Exception {
        ...
        mockMvc.perform(post("/bia/account/1")
    ...
    void shouldGetAccountByAccountNumber() throws Exception {
        ...
        mockMvc.perform(get("/bia/account/12345678-9"))
                .andExpect(status().isOk())
    ...
    void ShouldDeleteAccount() throws  Exception{
        ...
        mockMvc.perform(delete("/bia/account/12345678-9"))
                .andExpect(status().isOk())
                .andExpect(content().string(":( Sua conta foi deletada, espero que continue sendo nosso cliente"));
    }
}
