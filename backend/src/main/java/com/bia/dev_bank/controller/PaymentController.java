...
public class PaymentController {
    ...
    @Operation(summary = "getLoanPaymentByID", description = "Retrieves loan payment details for the specified loan payment ID.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "getCardPaymentByID", description = "Retrieves card payment details for the specified card payment ID.")
    @ApiResponses(value = {
