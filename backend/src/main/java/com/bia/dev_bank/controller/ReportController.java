...
public class ReportController {
    ...
    @Operation(summary = "transactionReport", description = "Retrieves the transaction report for a specific account number")
    @ApiResponses(value = {
    ...
    @Operation(summary = "cardDebitReport", description = "Retrieves all debit card transactions for a specific card number")
    @ApiResponses(value = {
    ...
    @Operation(summary = "cardCreditReport", description = "Retrieves all credit card transactions for a specific card number")
    @ApiResponses(value = {
    ...
    @Operation(summary = "allReports", description = "Retrieves all reports (transactions, credit, debit) for a specific account")
    @ApiResponses(value = {
