...
public class CardController {
    ...
    @Operation(summary = "Create a new card for an account", description = "Creates a new card associated with the specified account number.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Add a credit card purchase", description = "Registers a new purchase on the credit card and updates the card balance.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Add a debit card purchase", description = "Registers a new purchase using the debit card, deducting the amount from the linked account.")
    @ApiResponses(value = {
