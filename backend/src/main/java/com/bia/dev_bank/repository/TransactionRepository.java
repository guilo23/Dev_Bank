...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
  ...
  List<Transaction> findByOriginAccountAccountNumberOrderByTransactionDateDesc(
      String accountNumber);

  List<Transaction> findByDestinyAccountAccountNumberOrderByTransactionDateDesc(
      String accountNumber);
