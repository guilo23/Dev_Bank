...
public class LoanService {
    ...
    public void generatedLoanPayments(Loan loan) {
        ...
        BigDecimal monthlyAmount = totalAmount.divide(BigDecimal.valueOf(term), 2, RoundingMode.HALF_UP);
        ...
        for (int i = 0; i < term; i++) {
            ...
            payment.setPaymentAmount(monthlyAmount.add(monthlyAmount.multiply(payment.getInterestAmount())));
